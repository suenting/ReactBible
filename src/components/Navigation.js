...
const Navigation = (props) => {
    ...
    return (
        <div className="Navigation">
            <SearchDialog open={searchOpen} onClose={() => {setSearchOpen(false)}} actions={props.actions} />
            <List component="nav">
                <ListItem>
                ...
                <ListItem>
                    ...
                    <ListItemText>
                        <button id="toggletheme" className="navbtn btn btn-outline-primary" onClick={(event) => {setSearchOpen(true)}}>Search</button>
                    </ListItemText>
                </ListItem>
                <Divider />
                <ListItem>
